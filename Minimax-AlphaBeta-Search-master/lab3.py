...
#run_game(basic_player, basic_player)
#run_game(longest_streak_to_win_player, human_player)
...
def alpha_beta_search(board, depth,
    ...
    global alpha_beta_column_choice
    time1 = time()
    ...
    #For each of the next moves,based
    ...
    return alpha_beta_column_choice
    raise NotImplementedError
...
#run_game(new_player, alphabeta_player)
...
## Uncomment this
#  (or run it in the command window) to see how you do
